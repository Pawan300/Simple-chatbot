...
class Model:
    ...
    def define_model(self):
        ...
        net = tflearn.fully_connected(
            net, len(self.output_data[0]), activation="softmax"
        )
    ...
    def prepare_data(self, data_path, parameter_path):
        ...
        try:
            ...
            with open(parameter_path, "wb") as file:
                pkl.dump(
                    (self.training_data, self.output_data, self.dictionary, labels),
                    file,
                )
        ...
        while True:
            ...
            try:
                ...
                prediction = self.model.predict(
                    [bag_of_words(user_input, self.dictionary)]
                )
...
def argument_parser():
    ...
    parser.add_argument(
        ...
        "--save_parameter",
        dest="save_parameter",
        default="parameter/parameter.pkl",
    )
